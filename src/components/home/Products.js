  ...
  return (
    <div className="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-10 xl:gap-4 px-4">
      ...
      {productData.map((item) => (
        <div
          key={item.id}
          className="bg-white h0auto border-[1px] border-gray-200 py-8 z-30 hover:border-transparent shadow-none hover:shadow-testShadow duration-200 flex flex-col gap-4 relative"
        >
          ...
          <div className="w-full h-auto flex items-center justify-center relative group">
            <img
              ...
              alt="ProductImg"
            />
            <ul className=" w-full h-36 bg-gray-100 absolute bottom-[-170px] flex flex-col justify-center items-end gap-2 font-titleFont px-2 border-1 border-r group-hover:bottom-0 duration-700">
