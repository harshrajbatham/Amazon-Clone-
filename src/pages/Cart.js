      ...
      <div className="w-full bg-gray-100 p-4">
        {products.length > 0 ? (
          <div className="container mx-auto h-auto grid grid-cols-5 gap-8">
            ...
            <div className="col-span-5 md:col-span-3 lg:col-span-2 xl:col-span-1 bg-white h-52 flex flex-col justify-center items-center p-4">
              <div>
            ...
            <div>
              ...
              <div className="w-96 p-4 bg-white flex  flex-col items-center rounded-md shadow-lg">
                ...
                <p className="text-sm text-center">
                  Your Shopping cart is clear just like you are lonely in your
                  life.
                </p>
                <Link to="/">
