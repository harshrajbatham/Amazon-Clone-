      ...
      signInWithEmailAndPassword(auth, email, password)
        ...
        .catch((error) => {
          ...
          if (errorCode.includes("auth/wrong-password")) {
            setUserPassErr("Wrong Passwprd is Enter, try again");
          }
          console.log(errorCode, errorMessage);
          console.log("something is  up , try again with correct details");
        });
...
<p className="border-[1px] border-gray-600 text-gray-500 font-titleFont text-lg font-semibold px-6 py-2">
  {succesMsg}
</p>
            </div>
          ) : (
        ...
        <div className="w-full bg-gradient-to-t from-white via-white to-zinc-200 flex flex-col gap-4 justify-center items-center py-10">
          ...
          <p className="text-xs text-gray-600">© 2023, By Harshraj Batham !</p>
        </div>
      </div>
    </>
  );
